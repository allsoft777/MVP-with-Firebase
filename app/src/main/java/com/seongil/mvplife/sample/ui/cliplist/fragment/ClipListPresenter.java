...
public class ClipListPresenter extends RxMvpPresenter<ClipListView> {
    ...
    private void reportAnalyticsForSharingItems(int size) {
        ...
        bundle.putString(FirebaseAnalytics.Param.ITEM_NAME, "share_items_count_on_listview");
        bundle.putInt(FirebaseAnalytics.Param.VALUE, size);
        AnalyticsReporter.shareClipItem(bundle);
    }
